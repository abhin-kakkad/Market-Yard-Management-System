...
public class Retailer {
	...
	public String registration_form()
	{
		...
		app.insertRetailer(this.getName(), this.getEmail_id(), this.getPhone_no(), this.getPassword(), this.getBank_details());
	...
	public void update_profile(String id1)
	{
		...
		while(true)
		{
			...
			String uname=d1.getName(id,"retailer");
			String uemailid=d1.getemailid(id,"retailer");
			
			String phoneNo=d1.getphoneno(id,"retailer");
			String pwd=d1.getPassword(phoneNo,"retailer");
			String bd=d1.getbank(id,"retailer");
			int status=0;
			if(choice>6)
			   {
				   status=1;
	...
	public void buygoods(String id)
    {
    	...
    	System.out.println("So Retailer's total amount will be:"+ price*quant1);
	    ...
	    if(result.equals("yes"))
	    {
	    	...
	    	System.out.println("Confirmed final price for Retailer="+trader_price);
	    	Receipt r = new Receipt();
	    	r.generatebill("retailer", id, tprice, tquant);
	    }
	    else
	...
	public double bargain(double customer_price)
    {
    	...
    	if(c=='N')
    	{
    		System.out.println("Confirmed final price="+customer_price);
    		return customer_price;
    	}
    	else
    	{
    		System.out.println("Enter Trader's price:");
	...
	public void listofactions(String id)
	{
		...
		while(flag==1)
		{
			System.out.println("Available actions for retailer are given below:\n1.Update Profile\n2.Buy Goods from farmer\n");
